...
const ProgressIndicator = ({ step, setStep }: ProgressIndicatorProps) => {
      ...
      <div className="w-full max-w-sm">
        ...
        >
          ...
          <motion.button
            ...
            className={cn(
              "px-4 py-3 rounded-full text-white bg-white/20 hover:bg-white/30 border border-white/35 transition-colors flex-1 w-56 shadow-lg shadow-black/25",
              !isExpanded && "w-44"
            )}
          >
